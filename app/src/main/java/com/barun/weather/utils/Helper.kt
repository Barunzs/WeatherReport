...
import com.barun.weather.data.response.weather.DayWeatherItem
import com.barun.weather.data.response.weather.HourlyWeatherItem
import com.barun.weather.data.response.weather.WeatherData
import com.barun.weather.ui.dashboard.adapter.DayWeatherAdapter
import com.barun.weather.ui.dashboard.adapter.HourlyWeatherAdapter
...
fun updateUi(view: View, weatherData: WeatherData) {
    ...
    temp = weatherData.current.feelsLike.toString() + " "
